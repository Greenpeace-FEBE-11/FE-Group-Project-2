...
const Penanggulangan = () => {
    ...
    <br/><br/>
        ...
        <div className="row" style={{paddingLeft: "2rem"}}>
            <div className="col">
                <div className="card" style={{width: "18rem", minHeight:"350px", borderRadius: "35px", backgroundColor: "#018071", border: "none"}}>
                    <p className="himbauan">Tidak membuang sampah dan <br/> bahan - bahan pencemar ke sungai, danau dan laut</p>
                    <img src={himbauan1Img} style={{width: "50%", marginLeft: "60px"}}/>
                </div>
            </div>
            
            <div className="col">
                <div className="card" style={{width: "18rem", minHeight: "350px", borderRadius: "35px", backgroundColor: "#08B88A", border: "none"}}>
                    ...
                    <img src={himbauan2Img} style={{width: "35%", marginLeft: "90px"}}/>
                </div>
            </div>

            <div className="col">
                <div className="card" style={{width: "18rem", minHeight: "350px", borderRadius: "35px", backgroundColor: "#91DF89", border: "none"}}>
                    <p className="himbauan-2">Melaporkan kepada pihak bewajib jika ada pihak yang mencemari lingkungan perairan</p>
                    <br/><img src={himbauan3Img} style={{width: "23%", height: "9em", marginLeft: "30px"}}/>
                </div>
            </div>

            <div className="col">
                <div className="card" style={{width: "18rem", minHeight: "350px", borderRadius: "35px", backgroundColor: "#FDE3B3", border: "none;"}}>
                    <p className="himbauan-2">Bersama - sama anggota masyarakat lainnya melakukan upaya menjaga sungai dari pencemaran</p>
                    <img src={himbauan4Img} style={{width: "45%", marginLeft: "160px", marginTop: "20px"}}/>
                </div>
            </div>
        </div>
